...
Statement st;
        ...
        public Fenetre(){
                ...
                JPanel p = new JPanel();
        // Couleurs des lignes
                Color COULEURLIGNE1 = Color.BLUE;
        ...
        // Creation du graphique
                chart = ChartFactory.createTimeSeriesChart("test","Produit","Qte",dataSet,true,false,false);
...
public void addData()
        ...
        public void addData1(){
             ...
             catch(Exception e){System.out.println("Erreur d'ex̩cution de la requ̻te");}
                chart.setTitle("Exemple de Graphique");
                chartPanel.setChart(chart);
        }
}
